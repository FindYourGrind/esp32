...
#include "../Adafruit_SSD1306-Library/Adafruit_SSD1306.h"
#include "sdkconfig.h"

static char tag[] = "Adafruit_SSD1306";
...
Adafruit_SSD1306::Adafruit_SSD1306(
	...
	int8_t DC,
	int8_t RST,
	int8_t CS) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
...
void Adafruit_SSD1306::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  ...
  gpio_set_direction((gpio_num_t)dc, GPIO_MODE_OUTPUT);
	...
	ESP_LOGI(tag, "test abcd: sclk: %d, sid: %d", sclk, sid);
	spi_bus_config_t bus_config;
	bus_config.sclk_io_num   = sclk; // CLK
	bus_config.mosi_io_num   = sid; // MOSI
...
void Adafruit_SSD1306::invertDisplay(uint8_t invert) {
  if (invert) {
